# Phase 2 — Journal d'implémentation

Ordre de lecture recommandé :

1. [01-tool-system-et-file-reader.md](./01-tool-system-et-file-reader.md)
2. [02-tool-web-search.md](./02-tool-web-search.md)
3. [03-modeles-plan-et-planner.md](./03-modeles-plan-et-planner.md)
4. [04-executor.md](./04-executor.md)
5. [05-tools-sandboxes-docker.md](./05-tools-sandboxes-docker.md)
...
15. [15-fix-image-playwright-sans-paquet-pip.md](./15-fix-image-playwright-sans-paquet-pip.md)
